...
const HiyringPage = () => {
    ...
    return (
        <div className={`relative min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-brand-light-bg' : ''}`}>
            ...
            <section className={`py-24 transition-colors ${theme === 'dark' ? 'bg-white' : 'bg-brand-green-50'}`}>
                <div className="container mx-auto px-4 md:px-6">
                    <div className="text-center mb-16">
                        <h2 className={`text-4xl md:text-5xl font-sans font-bold mb-6 ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>4,500+ companies already using our platform</h2>
                    </div>
                    <ImpactMetrics statistics={hiyringStats} />
                </div>
            </section>

            <section className={`py-24 relative overflow-hidden transition-colors ${theme === 'dark' ? 'bg-brand-light-bg' : 'bg-white'}`}>
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="text-center mb-16">
                        <span className={`font-bold tracking-widest uppercase text-sm mb-4 block ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-brand-green-600'}`}>Workflow</span>
                        <h2 className={`text-4xl md:text-5xl font-sans font-bold mb-6 ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Streamlined, Scientific, Seamless</h2>
            ...
            <section className={`py-24 overflow-hidden transition-colors ${theme === 'dark' ? 'bg-white' : 'bg-brand-green-50/30'}`}>
                <div className="container mx-auto px-4 md:px-6">
                    <div className="mb-16">
                        <span className={`font-bold tracking-widest uppercase text-sm mb-4 block ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-brand-green-600'}`}>Features</span>
                        <h2 className={`text-4xl md:text-5xl font-serif leading-tight ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Everything you need to <br className="hidden md:block" />hire brilliantly</h2>
            ...
            <section className={`py-24 transition-colors ${theme === 'dark' ? 'bg-brand-light-bg' : 'bg-white'}`}>
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        {/* Companies */}
                        <div>
                            <span className={`font-bold tracking-widest uppercase text-sm mb-4 block ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-brand-green-600'}`}>FOR COMPANIES</span>
                            <h2 className={`text-3xl md:text-4xl font-bold mb-6 ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Build world-class teams faster</h2>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    <div className={`mt-1 w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 ${theme === 'dark' ? 'bg-[#2D6A4F]/20' : 'bg-brand-green-100'}`}>
                                        <CheckCircle className={`w-4 h-4 ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-brand-green-600'}`} />
                                    </div>
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Reduce Time-to-Hire by 70%</h4>
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Save 40+ Hours Weekly</h4>
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Better Candidate Quality</h4>
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Scale Effortlessly</h4>
                        ...
                        {/* Candidates */}
                        <div>
                            <span className={`font-bold tracking-widest uppercase text-sm mb-4 block ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-brand-green-600'}`}>FOR CANDIDATES</span>
                            <h2 className={`text-3xl md:text-4xl font-bold mb-6 ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Land your dream job with confidence</h2>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Interview on Your Terms</h4>
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Get Instant Feedback</h4>
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Fair & Unbiased Process</h4>
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className={`font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Practice & Prepare</h4>
            ...
            {/* FAQ */}
            <section className={`py-24 transition-colors ${theme === 'dark' ? 'bg-white' : 'bg-gray-50'}`}>
                <div className="container mx-auto px-4 md:px-6 max-w-3xl">
                    <h2 className={`text-3xl md:text-4xl font-bold mb-12 text-center ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>Frequently Asked Questions</h2>
                    <div className="space-y-4">
                        {hiyringFaq.map((item, idx) => (
                            <div key={idx} className={`rounded-2xl border overflow-hidden ${theme === 'dark' ? 'bg-brand-light-bg border-[#C8E6DA]/20' : 'bg-white border-gray-200'}`}>
                                <button
                                    onClick={() => setOpenFaqIndex(openFaqIndex === idx ? null : idx)}
                                    className={`w-full text-left p-6 flex justify-between items-center transition-colors ${theme === 'dark' ? 'hover:bg-white' : 'hover:bg-gray-50'}`}
                                >
                                    <span className={`text-lg font-bold ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-900'}`}>{item.question}</span>
                                    {openFaqIndex === idx ? (
                                        <Minus className={`w-5 h-5 flex-shrink-0 ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-400'}`} />
                                    ) : (
                                        <Plus className={`w-5 h-5 flex-shrink-0 ${theme === 'dark' ? 'text-[#2D6A4F]' : 'text-gray-400'}`} />
                                    )}
                                </button>
                                <AnimatePresence>
                                    {openFaqIndex === idx && (
                                        ...
                                        >
                                            <div className={`p-6 pt-0 leading-relaxed border-t ${theme === 'dark' ? 'text-dark-text-muted border-[#C8E6DA]/10' : 'text-gray-600 border-gray-50'}`}>
                                                {item.answer}
                                            </div>
                                        </motion.div>
                                    )}

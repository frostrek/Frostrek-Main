            ...
            <section className="relative pt-28 pb-16 md:pt-48 md:pb-32 overflow-hidden flex flex-col justify-center min-h-[90vh]">
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10 text-center flex flex-col items-center">
                    <div className="max-w-5xl mx-auto w-full flex flex-col items-center">
                        ...
                        >
                            We take foundation models from generic to genuinely useful — fine-tuned on your proprietary data, aligned to your exact standards, and deployed at scale. Skip the infrastructure overhead and get straight to a model that works.
                        </SplitTextReveal>

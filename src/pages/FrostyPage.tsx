                    ...
                    <div ref={processRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        ...
                        {PROCESS_STEPS.map((step) => (
                            <div key={step.step} className="process-step flex flex-col items-center text-center relative group">
                                ...
                                {/* Step Number */}
                                <div className="w-8 h-8 rounded-full border border-[#0068FF]/30 flex items-center justify-center text-[#0068FF] text-sm font-bold bg-[#0068FF]/5 mt-auto shadow-sm">
                                    {step.step}
                                </div>
                            </div>
                        ))}

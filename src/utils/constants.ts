        ...
        megaMenu: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: 'Vedashi Ecommerce', href: '/products/vedashi-ecommerce', desc: 'Premium, hyper-personalized online storefronts with WhatsApp recovery.', icon: '/products/vedashi-logo.png', hoverBgClass: 'hover:bg-[#F0FDF4]' },

...
const PRODUCTS = [
    ...
    },
    {
        ...
        icon: <img src="/icons/ai-blue.webp" alt="AI Agents" className="w-7 h-7 md:w-10 md:h-10 object-contain" loading="lazy" width={512} height={512} />,
        bgColor: 'bg-white',
    ...
    },
    {
        ...
        icon: <img src="/icons/machine-learning-lavender.webp" alt="AI Model Training" className="w-7 h-7 md:w-10 md:h-10 object-contain" loading="lazy" width={512} height={512} />,
        bgColor: 'bg-white',

...
const PRODUCTS = [
    {
        ...
        icon: <img src="/optimized/vedashi-logo-sm.webp" alt="Vedashi" className="w-8 h-8 md:w-12 md:h-12 object-contain" loading="lazy" width={80} height={68} />,
        bgColor: 'bg-white',
    ...
    },
    {
        ...
        icon: <img src="/optimized/ai-blue.webp" alt="AI Agents" className="w-7 h-7 md:w-10 md:h-10 object-contain" loading="lazy" width={70} height={70} />,
        bgColor: 'bg-white',
    ...
    },
    {
        ...
        icon: <img src="/optimized/machine-learning-lavender.webp" alt="AI Model Training" className="w-7 h-7 md:w-10 md:h-10 object-contain" loading="lazy" width={70} height={70} />,
        bgColor: 'bg-white',

...
const CuteBackground = () => {
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[#FDFBF7] via-[#FDFBF7] to-[#2EE1C7]/30" />
                ...
                >
                    <defs>
                        ...
                        <linearGradient id="wave-gradient-1" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="#2EE1C7" stopOpacity="0.08" />
                            <stop offset="100%" stopColor="#2EE1C7" stopOpacity="0.03" />
                        </linearGradient>
                        <linearGradient id="wave-gradient-2" x1="100%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%" stopColor="#2EE1C7" stopOpacity="0.1" />
                            <stop offset="100%" stopColor="#2EE1C7" stopOpacity="0.03" />
                        </linearGradient>
                    </defs>
            ...
            <div className="absolute inset-0">
                <div
                    className="absolute top-[10%] left-[15%] w-[400px] h-[400px] bg-[#2EE1C7]/20 rounded-full blur-[100px] animate-blob-slow"
                    style={{ willChange: 'transform' }}
                />
                <div
                    className="absolute bottom-[15%] right-[10%] w-[450px] h-[450px] bg-[#2EE1C7]/30 rounded-full blur-[110px] animate-blob-medium"
                    style={{ willChange: 'transform' }}
                />
            </div>
            ...
            <div className="absolute inset-0">
                <div className="absolute top-[18%] left-[15%] animate-sparkle-slow">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#2EE1C7]/40 shadow-sm shadow-[#2EE1C7]/30" />
                </div>
                <div className="absolute top-[35%] right-[25%] animate-sparkle-medium">
                    <div className="w-1 h-1 rounded-full bg-[#2EE1C7]/30" />
                </div>
                <div className="absolute bottom-[35%] left-[20%] animate-sparkle-fast">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#2EE1C7]/30" />
                </div>
                <div className="absolute bottom-[25%] right-[30%] animate-sparkle-slow">
                    <div className="w-1 h-1 rounded-full bg-[#2EE1C7]/20" />
                </div>
            </div>
        </div>
    );

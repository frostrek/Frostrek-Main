            ...
            >
                {isOpen ? (
                    ...
                    <div className="w-16 h-16 sm:w-[72px] sm:h-[72px] relative flex items-center justify-center bg-transparent transition-all hover:scale-105">
                        <img src="/optimized/chatbot.webp" alt="Chat" className="w-full h-full object-contain" loading="lazy" width={160} height={160} />
                        <motion.div
                            ...
                            >
                                <div className="flex items-center gap-3 pointer-events-none">
                                    <div className="w-12 h-12 bg-transparent flex items-center justify-center overflow-hidden">
                                        <img src="/optimized/chatbot.webp" alt="chatbot" className="w-10 h-10 object-contain translate-y-1" loading="lazy" width={160} height={160} />
                                    </div>
                                    <div>
                                    ...
                                    {messages.length === 0 && (
                                        ...
                                        >
                                            <div className="w-20 h-20 bg-transparent flex items-center justify-center mx-auto mb-6 overflow-hidden">
                                                <img src="/optimized/chatbot.webp" alt="Frosty" className="w-16 h-16 object-contain translate-y-2" loading="lazy" width={160} height={160} />
                                            </div>
